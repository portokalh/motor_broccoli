 antspath='/cm/shared/apps/ANTS/';%'/Users/alex/ANTs/antsbin/bin/';
addpath('/Users/alex/Documents/MATLAB/alex/NIfTI_20140122/')
addpath('/home/abadea/alxscripts/NIFTI_20140122')
addpath('/Users/alex/Documents/MATLAB/alex/');
pathin='/Users/alex/brain_data/motor/exvivolabels/';
pathin='/glusterspace/VBM_14obrien01_DTI101b_clean-work/dwi/fa/faMDT_Control_n12/median_images/'
pathout='/glusterspace/motor/median_images/'; %'/Users/alex/brain_data/motor/exvivolabels/GM_WM/';

flist=dir([pathin '*labels_chass_symmetric2.nii.gz']);
numfiles=size(flist);
numfiles=numfiles(1)
...
myfilename=labelfile;
myroots2='MDT_labels_chass_symmetric2';
...
sfile=[pathin myroots2,'GM_WM.nii.gz']  ;
gfile=[pathin myroots2,'GMp.nii.gz'] ;
wfile=[pathin myroots2,'WMp.nii.gz']  ;
thickfile=[pathin myroots2,'_ct.nii.gz']  ;
...
myGM((0<mylabelsim & mylabelsim< 47) |  mylabelsim==125 | mylabelsim==49 | mylabelsim==53  | mylabelsim==55 | mylabelsim==57 | mylabelsim==58| mylabelsim==149)=2.0;
myGM((1000<mylabelsim & mylabelsim< 1047) | mylabelsim==1125 | mylabelsim==1049 | mylabelsim==1053  | mylabelsim==1055 | mylabelsim==1057 | mylabelsim==1058| mylabelsim==1149)=2.0;
myGM(89<=mylabelsim & mylabelsim<=117 )=0;
myGM(mylabelsim==42)=2;
myGM(mylabelsim==7)=2;myGM(mylabelsim==8)=2;
